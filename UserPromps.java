public class UserPromps {
    ...
    static void getUserprompts(Boolean manager){
        System.out.println("\n\n\nWelcome to store invintory management helper, how may I help you today?");
    ...
    static void getUserprompts(){
        ...
        System.out.println("Sort and Print current invintory by entering 5");
        System.out.println("You can quit by entering 6");
    }
}
